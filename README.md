...
| # | 文档 | 读什么 | 何时读 |
|:--:|------|--------|--------|
| **1** | `财务RAG-资料收集蓝图.md` | 7 大知识域，"收集什么" | 了解项目全貌 |
| **2** | `财务RAG-MVP资料收集执行表.md` | 70 项资料 + 下载链接 + 优先级 | 动手收集资料 |
| **3** | `财务RAG-资料收集预处理方案.md` | 目录结构 + 元数据 + MarkItDown + 质检 | 组织与清洗资料 |
| **4** | `财务RAG-技术架构与Agent方案.md` | 技术栈 + 检索链路 + 6 工具 + UX 规范 | 了解系统设计 |
| **5** | `财务RAG-产品定义与答辩策略.md` | 用户故事 + 亮点 + PPT + 演示 | 准备答辩 |
| **6** | `财务RAG-UI设计方案.md` | 布局 + 3 个视图 + SSE 格式 + 设计系统 | 了解 UI 设计 |
| **7** | `财务RAG-AI提示词工程文档-v1.0.md` | TypeScript 类型 + 组件树 + hooks + SSE + 样式 | **AI 编码时粘贴为上下文** |
| **8** | `财务RAG-开发注意事项.md` | CSS 令牌 + 组件 + SSE + 无障碍 + API 路由 | 编码时查规范 |
| **9** | `财务RAG-后端开发路线图.md` | 7 步后端开发 + 面试话术 + 注意事项 | 后端编码指南 |
| **10** | `财务RAG-前后端对照表.md` | 接口 + SSE 事件 + 数据类型 + 联调清单 | 前后端联调 |
...
Phase 0 — 方案设计 ✅ 已完成（本文档体系）
    │
Phase 1 — 资料收集     → `财务RAG-资料收集预处理方案.md`
    │
Phase 2 — 后端开发     → `财务RAG-后端开发路线图.md`（7 步）
    │                     🎯 第一 checkpoint：RAG 问答可流式回答一个税务问题
    │
Phase 3 — 前端开发     → `财务RAG-AI提示词工程文档-v1.0.md`
    │
Phase 4 — 联调 & 演示  → `财务RAG-前后端对照表.md`
    │
Phase 5 — 答辩准备     → `财务RAG-产品定义与答辩策略.md`
```

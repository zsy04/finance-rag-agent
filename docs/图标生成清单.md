...
> **统一风格**：扁平化 · 线性图标 · 线条粗 2px · 圆角端点 · 深藏蓝单色（`#1E3A8A`） · 透明背景 · 方形画布
...
Line art style, 2px stroke, deep navy blue (#1E3A8A), transparent background.
...
2px stroke, deep navy blue (#1E3A8A), rounded caps.
...
生成 512×512px PNG → 使用在线工具（如 vectorizer.io）转 SVG → 手动调整颜色为 `#1E3A8A`
